...
public class JuntaResultadosFutureWSFutureBanco implements Callable<Void> {
	...
	public Void call() {
		...
		try {
			String tempoEsperaWS = this.futureWS.get(20, TimeUnit.SECONDS);
			String tempoEsperaBanco = this.futureBanco.get(20, TimeUnit.SECONDS);

			this.saidaCliente.println("Resultado do comando c2: " + tempoEsperaWS + ", " + tempoEsperaBanco);
